...
export const SERVICES: Service[] = [
	{
		...
		title:
			"Enterprise-Grade Artificial Intelligence Platform and Development with 60+ Reuseable Accelerators",
		description:
			...
			metrics: [
				{
					value: "30-60%",
					description:
						"Reduction in operational costs through process optimization and intelligent automation.",
				},
				{
					value: "Up to 2×",
					description:
						"Faster process turnaround, enabling teams to focus on innovation and strategic priorities.",
				},
				{
					value: "Improved",
					description:
						"Data accuracy and compliance, minimizing human error and strengthening governance.",
				},
				{
					value: "Greater",
					description:
						"Transparency across workflows for smarter, accountable decision-making.",
				},
			],
		},
		industries: [
			...
			metrics: [
				{
					value: "30–50%",
					description:
						" Reduction in operational effort through process automation.",
				},
				{
					value: "2× Faster",
					description:
						"Turnaround for repetitive workflows like compliance reporting and claims processing.",
				},
				{
					value: "Zero-Error Tolerance",
					description:
						"Automation fine-tuned to industry regulations for accuracy and compliance.",
				},
				{
					value: "Scalable Frameworks",
					description:
						"Adapt quickly to changing business needs without over-engineering.",
				},
			],
		},
		industries: [
	...
	},
	{
		...
		description:
			"Gain real-time insights and dashboards to make confident, data-driven decisions.",
		meta: {
			keywords: [
				"data analytics",
	...
	},
	{
		...
		description:
			"Keep mission-critical platforms resilient, secure, and performing at their best.",
		meta: {
			keywords: [
			...
			certifications: [
				"Platform Security Certified",
				"Infrastructure Management Certified",
			],
			technologies: [
				"Platform Monitoring",
				"Security",
	...
	},
	{
		...
		description:
			"Scale your teams flexibly with the right tech talent, when you need it.",
		meta: {
			keywords: [
				"talent augmentation",
				"tech talent",

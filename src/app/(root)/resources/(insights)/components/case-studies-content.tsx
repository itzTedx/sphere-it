...
export const CaseStudiesContent = ({
	...
	return (
		...
		>
			<div
				className={cn(
					"grid gap-6 overscroll-auto",
					study.client ? "lg:grid-cols-[1fr_1.65fr]" : "mx-auto max-w-3xl"
				)}
			>
				{study.client && (
					<aside className="hidden border-r lg:block lg:py-6 lg:pr-6">
						<div className="sticky top-20 space-y-6 rounded-lg bg-card p-6">
							...
							<div className="space-y-2">
								<h3 className="font-mono text-badge text-muted-background uppercase">
									About
								</h3>
							...
							{study.client?.industry && (
								<div className="space-y-2">
									...
									<p className="text-pretty text-subhead-base">
										{study.client?.industry}
									</p>
								</div>
							)}

			...
			<CardHeader className="p-6 text-center">
				...
				<div className="space-y-2">
					...
					<div className="flex items-center justify-center gap-3">
						...
						<span className="font-semibold text-lg text-stone-600">
							{result.percentage}%
						</span>
					</div>
				</div>
			...
			<CardContent className="space-y-6">
				...
				<div className="rounded-lg border border-primary-200 bg-primary-50 p-4">
					<p className="text-primary-900 text-sm leading-relaxed">
						<strong>Note:</strong> Lower scores indicate higher maturity. Your
						score of {result.totalScore} ({result.percentage}%) places you in
						the <strong>{result.level}</strong> category.
					</p>
				</div>
			</CardContent>
		</Card>

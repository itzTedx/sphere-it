...
Complete list of our core service offerings:\n\n`;
		...
		for (const website of services) {
			...
			content += `- [${website.title}](${serviceUrl}/llms.txt): ${description}\n`;
		}
...
Learn more about Sphere Global and connect with our team:\n\n`;
		content += `- [About Us](${baseUrl}/about/llms.txt): Our company history, mission, vision, leadership team, and what drives us to deliver excellence in technology solutions\n`;
		content += `- [Careers](${baseUrl}/careers/llms.txt): Join our team of experts - explore job opportunities, company culture, benefits, and career growth at Sphere Global\n`;
		content += `- [Contact Us](${baseUrl}/contact/llms.txt): Get in touch with our team for consultations, partnerships, or inquiries - multiple contact methods and office locations\n`;

		// Add support section
		content += `\n## Support & FAQ

Get help and find answers to common questions:\n\n`;
		content += `- [FAQ](${baseUrl}/faq/llms.txt): Frequently asked questions about our services, implementation process, support, pricing, and technical requirements\n`;
		content += `- [Support Center](${baseUrl}/support/llms.txt): Technical support documentation, troubleshooting guides, and help resources for our clients and partners\n`;

		// Add additional pages
		content += `\n## Additional Pages

Other important sections of our website:\n\n`;
		content += `- [Partners](${baseUrl}/partners/llms.txt): Our technology partners, alliances, and ecosystem collaborations that enhance our service delivery\n`;
		content += `- [News & Events](${baseUrl}/news/llms.txt): Latest company news, press releases, upcoming events, webinars, and industry conference participation\n`;
		content += `- [Privacy Policy](${baseUrl}/privacy/llms.txt): Our commitment to data protection, privacy practices, and how we handle client information\n`;
		content += `- [Terms of Service](${baseUrl}/terms/llms.txt): Service agreements, terms of engagement, and legal framework for our offerings\n`;

			...
			<main aria-label="Terms of Service" role="main">
				...
				<section className="mx-auto grid max-w-7xl grid-cols-1 justify-center lg:grid-cols-4">
					...
					>
						<section aria-labelledby="introduction">
							...
							<p>
								Welcome to Sphere IT Global ("Sphere IT", "we", "our", or "us").
							</p>
							<p>
								By accessing or using our website{" "}
								{BASE_URL.replace("https://", "")} (the "Site") and submitting
								information through our contact form or any other means, you
								agree to comply with these Terms of Service ("Terms"). If you do
						...
						<div className="-mb-4 relative pt-4">
							<div className="relative">
								...
								<div className="ml-12 pb-4">
									<p>
										This website is operated by Sphere IT Global. Throughout
										this Site, the terms “we”, “us”, and “our” refer to Sphere
										IT.
									</p>
									<p>
										Sphere IT provides information about our services,
										expertise, and solutions, and allows you to contact us via
										forms. By using the Site, you agree to be bound by these
										Terms, including any referenced policies such as our Terms
										of service.
									</p>
									<p>
										New features, tools, or updates on the Site are also subject
										to these Terms. We reserve the right to update these Terms
										at any time by posting changes to this page. Your continued
								...
								<div className="ml-12 pb-4">
									<p>
										You agree to use the Site only for lawful purposes. You must
										not:
									</p>
									<ul>
										<li>
										...
										<li>
											Disrupt or interfere with the Site, its content, or
											services.
										</li>
										<li>
											Use automated tools to collect data or scrape content.
										</li>
										<li>
											Submit malicious code, viruses, or harmful material.
										</li>
									</ul>
									<p>
								...
								<div className="ml-12 pb-4">
									<p>
										When you submit your information via our contact forms, you
										agree that:
									</p>
									<ul>
										<li>
										...
										<li>
											Your submissions do not include unlawful, defamatory, or
											harmful content.
										</li>
										<li>
											Your data may be used by Sphere IT solely to respond to
											inquiries or provide requested services.
										</li>
									</ul>
									<p>
										All data collection and handling are subject to our Terms of
										service.
									</p>
								</div>
								...
								<div className="ml-12 pb-4">
									<p>
										Below is a list of definitions for the terms used in this
										Terms of service:
									</p>
								...
								<div className="ml-12 pb-4">
									<p>
										...
										software, is owned by Sphere IT or licensed to us.
									</p>
									...
									<ul>
										<li>
											View or download content for personal, non-commercial use.
										</li>
									</ul>
									<h3
										className="mt-6 mb-3 font-semibold text-lg"
										id="you-may-not"
									>
										You may not:
									</h3>
									<ul>
										<li>
											Copy, reproduce, distribute, or commercialize any content
								...
								<div className="ml-12 pb-4">
									<p>
										Our Site may contain links to third-party websites. We do
										not control or endorse these sites and are not responsible
										for their content or privacy practices. Visiting these links
										is at your own risk.
									</p>
								</div>
								...
								<div className="ml-12 pb-4">
									<p>
										To the fullest extent permitted by law, Sphere IT is not
								...
								<div className="ml-12 pb-4">
									<p>
										You agree to defend, indemnify, and hold harmless Sphere IT,
										its affiliates, employees, and partners from claims or
										damages resulting from your violation of these Terms or
										applicable law.
									</p>
								</div>
								...
								<div className="ml-12 pb-4">
									<p>
										...
										violations of these Terms. Termination does not relieve you
								...
								<div className="ml-12 pb-4">
									<p>
										...
										Emirates (UAE). Any disputes shall be resolved exclusively
										in Dubai courts.
									</p>
								</div>
								...
								<div className="ml-12 pb-4">
									<p>
										Sphere IT may update these Terms at any time. Updated
										versions will be posted on this page. Your continued use
							...
							<div className="ml-12 pb-4">
								<p>
									If you have any questions, requests, or concerns about these
									Terms of Service or our website usage policies, please contact
									us at:
								</p>
								<div className="mt-4 space-y-2">
									<p className="flex items-center gap-2">
										<span>📧</span>
										<Link
											href={`mailto:${LEGAL_HANDLING_EMAIL}`}
				...
				<div className="col-span-full border-t p-6 text-center lg:p-12">
					<p className="text-sm text-stone-500">
						Last Updated: {TERMS_SERVICES_LAST_UPDATED}
					</p>
				</div>
				<Cta />
			</main>

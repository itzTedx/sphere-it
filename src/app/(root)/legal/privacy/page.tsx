				...
				<section className="mx-auto grid max-w-7xl grid-cols-1 justify-center lg:grid-cols-4">
					...
					>
						<section aria-labelledby="introduction">
							...
							<p>
								Sphere IT provides technology, consulting, automation, and
								integration solutions to enterprises worldwide (the "Services").
							</p>
							<p>
								We value your privacy and are committed to protecting your
								personal data. This Privacy Policy explains how we collect, use,
								and protect information when you visit our website, communicate
								with us, or use our Services.
							</p>
							<p>
								By using our website or submitting your information through our
								contact forms, you agree to the practices described in this
								Privacy Policy.
							</p>
						</section>
							...
							<div className="relative">
								...
								<div className="ml-12 pb-4">
									...
									<ul>
										...
										<li>
											Provide information about our IT solutions and services
										</li>
										<li>Improve customer service and communication quality</li>
									</ul>
									<p>
										Your information is used only for the purpose for which you
										provided it and will never be sold or shared for marketing
										purposes.
									</p>
								</div>
								...
								<div className="ml-12 pb-4">
									<p>
										We use secure technologies and hosting infrastructure to
										safeguard your data. Your form submissions are transmitted
										over encrypted HTTPS connections and stored securely.
									</p>

									<p>
										While we strive to use industry-standard methods to protect
										your personal data, no system is completely secure. We
								...
								<div className="ml-12 pb-4">
									<p>
										...
										respond to your inquiry or fulfill the purpose for which it
										was collected.
									</p>
									<p>
										After that period, your data will be securely deleted or
										anonymized.
									</p>
									<p>
								...
								<div className="ml-12 pb-4">
									...
									<ul>
										<li>
											Authorized personnel within Sphere IT who are handling
											your inquiry
										</li>
										<li>
											Trusted third-party service providers (e.g., web hosting
											or email delivery) who assist in operating our website,
								...
								<div className="ml-12 pb-4">
									...
									<ul>
										...
										<li>
											Analyze website performance and visitor behavior (e.g.,
											Google Analytics)
										</li>
									</ul>
									<p>
										These cookies do not collect personal data or track your
										identity.
										<br />
										You may disable cookies in your browser settings at any
										time.
									</p>
								</div>
								...
								<div className="ml-12 pb-4">
									...
									<p>
										We are not responsible for their privacy practices and

...
import type { ListingService } from "@/modules/global/services";
...
export function ServiceCard({ service }: { service: ListingService }) {
					...
					<div className="flex items-center gap-2 md:gap-4">
						...
						{service.proof && (
							<Button asChild className="group relative z-50" variant="outline">
								<Link href={service.proof as Route}>Proof of Impact</Link>
							</Button>
						)}
					</div>
				</div>

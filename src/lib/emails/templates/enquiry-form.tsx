					...
					<Container className="mx-auto max-w-[600px] px-[20px]">
						...
						>
							...
							>
								...
								A potential client is interested in your enterprise IT solutions
							...
							<Text
								...
								style={{ color: "#18131F" }}
							>
								This enquiry represents a potential opportunity for your
								enterprise IT services. Please respond promptly to maintain
								Sphere IT Global's reputation for excellence and reliability.
							</Text>
						</Section>
...
EnquiryFormReact.PreviewProps = {
	name: "Ahmed Al-Rashid",
	email: "ahmed.rashid@example.com",
	phone: "+971 50 123 4567",
	subject: "Enterprise IT Solutions Inquiry",
	message:
...
export default EnquiryFormReact;

export const EnquiryFormPlainText = ({
	name,
	email,
	phone,
	subject,
	...
	return `New enquiry received from ${name}

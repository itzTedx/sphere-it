...
export function ContactResourcesSection() {
	return (
		<section className="container grid max-w-7xl gap-4 pb-16 sm:gap-6 sm:pb-24 md:grid-cols-3">
			...
			>
				...
				<div className="text-center">
					...
					<p className="text-primary-300 text-xs sm:text-sm">
						Connect with us on LinkedIn to explore our company updates,
						automation, and AI-driven transformation.
					</p>
				</div>
				<FlickeringGrid
					aria-hidden="true"
			...
			{resources.map(
				({ title, description, href, ariaLabel, linkTitle, buttonText }) => (
					<article

...
export const WhyUs = () => {
  return (
    <section
      ...
      className="relative z-50 my-20 border bg-card p-4 sm:p-6 md:mx-3 md:rounded-3xl md:p-12 lg:p-20"
    >
...
function PrecisionCard() {
  return (
    <article className="flex flex-col justify-between rounded-2xl bg-card shadow-md lg:row-span-2">
      <div className="space-y-4 p-6 sm:p-8 xl:p-10">
        <header>
          <Badge variant="ghost">Guided by</Badge>
          <h3 className="text-primary-900 text-title-5 md:text-title-4 xl:text-title-3">Precision & Pragmatism</h3>
        </header>
      ...
      <footer className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8 xl:p-10">
        <div>
...
function PartnerCard() {
  return (
    <article className="rounded-2xl bg-card shadow-md lg:col-span-2">
      <div className="relative h-48 w-full sm:h-56 xl:h-64">
        <Image
      ...
      <div className="p-6 sm:p-8 xl:px-10 xl:pb-10">
        <h3 className="text-primary-900 text-title-5 md:text-title-4 xl:text-title-3">
          Trusted Partner in BFSI and Beyond
        </h3>
        <p className="text-base text-muted-foreground xl:text-lg">
  ...
  return (
    <article className="rounded-2xl bg-card shadow-md lg:row-span-2">
      <div className="p-6 sm:p-8 lg:px-10 lg:pt-10">
        <h3 className="text-primary-900 text-title-5 md:text-title-4 xl:text-title-3">Reliability at the Core</h3>
        <p className="text-base text-muted-foreground xl:text-lg">
    ...
    <article className="flex flex-col rounded-2xl bg-card shadow-md lg:col-span-2 lg:flex-row">
      <div className="p-6 sm:p-8 lg:flex-1 lg:px-10 lg:pt-10">
        <header>
          ...
          <h3 className="text-primary-900 text-title-5 md:text-title-4 xl:text-title-3">Proven Delivery Framework</h3>
        </header>
        <p className="text-base text-muted-foreground xl:text-lg">

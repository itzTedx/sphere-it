...
export const Testimonials = () => {
  return (
    <section className="container">
      <div className="max-w-7xl py-20 md:container md:border-x">
        ...
        <div className="relative grid h-[90svh] gap-4 md:grid-cols-3">
        ...
        <div className="-mt-6 relative z-10 mx-auto flex w-fit items-center justify-center gap-1.5 rounded-full bg-card p-1.5 shadow-lg">
          <p className="px-3 font-sans text-muted-foreground text-xs md:text-base">View the impact on our clients</p>

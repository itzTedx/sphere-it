...
const UploadIllustration = () => (
  <div className="relative h-16 w-16">
    ...
    >
      ...
      <path
        className="fill-primary-100 stroke-primary-500"
      ...
      <g className="translate-y-2 transform">
        <line className="stroke-primary-500" strokeLinecap="round" strokeWidth="2" x1="50" x2="50" y1="45" y2="60">
...
export function FileUpload({
  ...
  return (
    <div aria-label="File upload" className={cn("relative mx-auto w-full max-w-sm", className)} role="complementary">
              ...
              <AnimatePresence mode="wait">
                {status === "idle" || status === "dragging" ? (
                  ...
                  >
                    ...
                    <button
                      className="group flex w-4/5 items-center justify-center gap-2 rounded-lg bg-gray-100 px-4 py-2.5 font-semibold text-gray-900 text-sm transition-all duration-200 hover:bg-gray-200"
                    ...
                    <p className="mt-3 text-gray-500 text-xs dark:text-gray-400">or drag and drop your file here</p>
                  ...
                  >
                    ...
                    <button
                      className="flex w-4/5 items-center justify-center gap-2 rounded-lg bg-gray-100 px-4 py-2.5 font-semibold text-gray-900 text-sm transition-all duration-200 hover:bg-gray-200"
                      onClick={resetState}
                      type="button"
                    >
                      Cancel

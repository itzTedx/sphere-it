  ...
  return (
    <TabsHighlightItemPrimitive className="flex-1" value={props.value}>
      <TabsTriggerPrimitive
        className={cn(
          "inline-flex h-[calc(100%-1px)] w-full flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-md bg-stone-alpha-10 px-2 py-1 font-medium text-muted-foreground text-sm transition-colors duration-500 ease-in-out focus-visible:border-ring focus-visible:outline-1 focus-visible:outline-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:text-foreground [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
          // Active State
          "data-[state=active]:text-primary-900 data-[state=active]:[&_div]:bg-primary-300 data-[state=active]:[&_svg]:text-primary-950",
          className
        )}
        {...props}
      />

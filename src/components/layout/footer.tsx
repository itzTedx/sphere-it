...
export const Footer = memo(() => {
  return (
    <footer aria-label="Site footer" className="bg-foreground" role="contentinfo">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="flex max-w-md flex-col justify-between gap-3">
              <div className="space-y-4 md:space-y-6">
                <Link aria-label="Sphere IT Global - Home" className="-m-2 block w-fit rounded-md p-2" href="/">

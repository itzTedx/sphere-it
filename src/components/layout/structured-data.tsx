...
export function StructuredData() {
	const organizationSchema = {
		...
		sameAs: [
			"https://linkedin.com/company/sphere-global",
			...
			itemListElement: [
				...
				},
				{
					...
					itemOffered: {
						...
						name: "Automate",
						description:
							"Simplify Core Processes, Reduce Errors, Maximize Value",
					},
				},
				{
					"@type": "Offer",
	...
	const websiteSchema = {
		...
		url: BASE_URL,
		description:
			"AI & Technology Solutions - Delivering Accuracy. Driving Outcomes.",
		publisher: {
			"@type": "Organization",
			name: "Sphere Global",
		},

...
import { getVariants, type IconProps, IconWrapper, useAnimateIconContext } from "@/components/ui/base/icon";
...
const animations = {
  default: {
    ...
    path1: { initial: { rotate: 0 }, animate: { rotate: 6 } },
    path2: {},
    path3: {
      initial: {
        y: 0,
...
export { animations, Trash, Trash as IconTrash, type TrashProps, type TrashProps as TrashIconProps };

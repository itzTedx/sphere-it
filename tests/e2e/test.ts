...
test.describe("Page Navigation", () => {
	...
	test.describe("Home Page Navigation", () => {
		test("should navigate to services page from home page CTA button", async ({
			page,
		}) => {
		...
		test("should navigate to contact page from home page CTA button", async ({
			page,
		}) => {
	...
	test.describe("Services Submenu Navigation", () => {
		test("should navigate to elevate service page from services submenu", async ({
			page,
		}) => {
		...
		test("should navigate to automate service page from services submenu", async ({
			page,
		}) => {
			const servicesButton = page.getByRole("button", { name: "Services" });
			await servicesButton.hover();
		...
		test("should navigate to evaluate service page from services submenu", async ({
			page,
		}) => {
			const servicesButton = page.getByRole("button", { name: "Services" });
			await servicesButton.hover();
		...
		test("should navigate to assure service page from services submenu", async ({
			page,
		}) => {
			const servicesButton = page.getByRole("button", { name: "Services" });
			await servicesButton.hover();
		...
		test("should navigate to augment service page from services submenu", async ({
			page,
		}) => {
			const servicesButton = page.getByRole("button", { name: "Services" });
			await servicesButton.hover();
	...
	test.describe("Resources Submenu Navigation", () => {
		test("should navigate to FAQs page from resources submenu", async ({
			page,
		}) => {
		...
		test("should navigate to blogs page from resources submenu", async ({
			page,
		}) => {
			const resourcesButton = page.getByRole("button", { name: "Resources" });
			await resourcesButton.hover();
		...
		test("should navigate to about page from resources submenu", async ({
			page,
		}) => {
			const resourcesButton = page.getByRole("button", { name: "Resources" });
			await resourcesButton.hover();
		...
		test("should navigate to careers page from resources submenu", async ({
			page,
		}) => {
			const resourcesButton = page.getByRole("button", { name: "Resources" });
			await resourcesButton.hover();
		...
		test("should navigate to contact page from resources submenu", async ({
			page,
		}) => {
			const resourcesButton = page.getByRole("button", { name: "Resources" });
			await resourcesButton.hover();
		...
		test("should navigate to case studies page from resources submenu", async ({
			page,
		}) => {
			const resourcesButton = page.getByRole("button", { name: "Resources" });
			await resourcesButton.hover();
		...
		test("should navigate to research papers page from resources submenu", async ({
			page,
		}) => {
			const resourcesButton = page.getByRole("button", { name: "Resources" });
			await resourcesButton.hover();
		...
		test("should navigate to testimonials page from resources submenu", async ({
			page,
		}) => {
			const resourcesButton = page.getByRole("button", { name: "Resources" });
			await resourcesButton.hover();
...
test.describe("Service Pages Navigation", () => {
	...
	for (const service of services) {
		test(`should navigate to ${service.name} service page directly`, async ({
			page,
		}) => {
		...
		test(`should navigate to ${service.name} service page from services listing`, async ({
			page,
		}) => {
...
test.describe("Breadcrumb Navigation", () => {
	test("should navigate back to services from service detail page", async ({
		page,
	}) => {
...
test.describe("Mobile Navigation", () => {
	...
	test("should open mobile menu and navigate to about", async ({ page }) => {
		...
		await page
			.getByRole("button", { name: "Toggle Resources submenu" })
			.click();
	...
	test("should open mobile menu and navigate to contact via footer button", async ({
		page,
	}) => {
		// Open mobile menu
		await page.getByRole("button", { name: "Open navigation menu" }).click();
